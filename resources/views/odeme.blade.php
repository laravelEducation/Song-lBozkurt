...
@section('title', 'Odeme'){{-- master blade içerisindeki @yield içerisindeki title i kategori olarak yazıdr demek--}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control telefon" name="ceptelefonu" id="ceptelefonu" required value="{{$kullanici_detay->ceptelefonu}}">
                        </div>
                    </div>
                </div>
            </div>
