            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="list-group categories">
                        ...
                        <a href="{{route('kategori',$kategori->slug)}}" class="list-group-item">{{-- burada name olarak vrdiğimiz  kategori routuna kategori_slug değeri ile beraber linkte bastiğimizda bu routu tanımlamış olduk--}}

                            <i class="fa fa-arrow-circle-o-right"></i> {{$kategori->kategori_adi}}</a>{{-- burada  kategori içerisindeki kategori adlarini yazdırmış oluruz--}}
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item {{$index == 0 ? 'active': ''}}">
                            ...
                            <div class="carousel-caption">
                              {{$urun->urun_adi}}  {{--  ürün modeli içerisindeki urun fonksiyonunun içerisindeki ürün adını getir    --}}
